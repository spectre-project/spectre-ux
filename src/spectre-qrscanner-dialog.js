...
class SpectreQRScannerDialog extends SpectreDialog{
	...
	static get styles(){
		return [SpectreDialog.styles, css`
			.container{
				...
				max-height:var(--spectre-dialog-container-max-height, 620px);
			}
...
SpectreQRScannerDialog.define("spectre-qrscanner-dialog");
