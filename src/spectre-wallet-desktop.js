import {html, css, FlowFormat, i18n, T} from './spectre-wallet-ui.js';
import {SpectreWalletMobile} from './spectre-wallet-mobile.js';

export class SpectreWalletDesktop extends SpectreWalletMobile{
	...
	static get styles(){
		return [SpectreWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--spectre-wallet-container-padding, 15px);
			...
			.wallet-warning{
				...
				background-color:var(--spectre-wallet-warning-bg, #fdf8e4);
			}
			...
			.right-area{
				...
				height:var(--spectre-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--spectre-wallet-top-menu-position, absolute);
				right:var(--spectre-wallet-top-menu-right, 20px);
				top:var(--spectre-wallet-top-menu-top, -4px);
				z-index:2;
			...
			.header{
				border-bottom:var(--spectre-wallet-header-border-bottom, --2px solid var(--spectre-wallet-tab-border-top-color, var(--flow-primary-color)));
			}
		`];
	}
	constructor() {
