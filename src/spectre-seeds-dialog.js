import {
	html, css, SpectreDialog, chunks, getRandomInt, shuffle,
	T, i18n
} from './spectre-dialog.js';

class SpectreSeedsDialog extends SpectreDialog{
	...
	static get styles(){
		return [SpectreDialog.styles, css`
			...
			.container{max-height:var(--spectre-dialog-container-max-height, 660px)}
...
SpectreSeedsDialog.define("spectre-seeds-dialog");
